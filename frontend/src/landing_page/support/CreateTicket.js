    ...
    return ( 
        <div className='container'>
            <div className='row p-3 mt-5'>
                ...
                <div className='col-lg-4 col-md-6'>
                    <h5 className='mb-4'><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Zerodha Account</h5>
                    ...
                    <a href = "" style = {{textDecoration: "none", lineHeight :"2.5"}}>Stockreportes +</a><br/>
            ...
            <div className='row p-3  mb-5'>
                ...
                <div className='col-lg-4 col-md-6'>
                    ...
                    <a href = "" style = {{textDecoration: "none", lineHeight :"2.5"}}>Managing yout Portfolio</a><br/>
